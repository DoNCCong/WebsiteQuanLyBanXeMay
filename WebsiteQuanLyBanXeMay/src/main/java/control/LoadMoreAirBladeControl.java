...
@WebServlet(name = "LoadMoreAirBladeControl", urlPatterns = {"/loadAirBlade"})
public class LoadMoreAirBladeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String soLuong = request.getParameter("exitsAdidas");
        int isoLuong = Integer.parseInt(soLuong);
        DAO dao = new DAO();
        List<XeMay> list = dao.getNext4AirBladeProduct(isoLuong);
        ...
        for (XeMay o : list) {
            out.println(" <div class=\"productAdidas col-12 col-md-6 col-lg-3\">\r\n"
            		...
            		+ "                                        <div class=\"row\">\r\n"
            		+ "                                            <div class=\"col\">\r\n"
            		+ "                                                <p class=\"btn btn-success btn-block\">"+String.format("%.0f",o.getGiaTien())+" VNĐ</p>\r\n"
            		+ "                                            </div>\r\n"
            		+ "                                           \r\n"
            		+ "                                        </div>\r\n"
            		+ "                                    </div>\r\n"
